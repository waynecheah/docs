...
If you met a bug while using, you can open an issue [here](https://github.com/waynecheah/docs/issues/new)
...
- [Badge `<Badge />`](markdown/components.md#badge): Added color support
